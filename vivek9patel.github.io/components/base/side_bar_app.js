    ...
    render() {
        return (
            <div
                ...
                className={(this.props.isClose[this.id] === false && this.props.isFocus[this.id] ? "bg-white bg-opacity-10 " : "") + " w-auto px-2 py-1.5 outline-none relative transition hover:bg-white hover:bg-opacity-10 rounded m-1"}
            ...
            >
                ...
                <div
                    className={
                        ...
                        " w-max py-0.5 px-1.5 absolute top-10 left-0 ml-3 m-1 text-ubt-grey text-opacity-90 text-sm bg-ub-grey bg-opacity-70 border-gray-400 border border-opacity-40 rounded-md"
                    }
                >
                    {this.props.title}
                </div>
